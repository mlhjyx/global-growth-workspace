    ...
    <div className="flex flex-col h-full">
      <div className="px-4 py-3 border-b border-primary-500/10 shrink-0">
        <div className="flex items-center gap-2">
          <span className="w-5 h-5 flex items-center justify-center text-primary-400"><i className="ri-robot-line"></i></span>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3">
        {relevantInsights.length === 0 ? (
          <div className="text-center py-8">
            <span className="w-12 h-12 flex items-center justify-center text-foreground-600 mx-auto mb-2"><i className="ri-robot-line text-2xl"></i></span>
          ...
          relevantInsights.map(insight => (
            ...
            >
              <div className="flex items-center gap-1.5 mb-2">
                <span className={`w-4 h-4 flex items-center justify-center ${typeConfig[insight.type].color}`}>
                ...
                <span className="text-foreground-600 text-[10px] ml-auto">置信度 {insight.confidence}%</span>
              </div>
              ...
              {insight.suggestedReply && (
                <div className="mt-2 p-2.5 rounded-lg bg-primary-500/5 border border-primary-500/10">
                  ...
                  <p className="text-foreground-200 text-[11px] leading-relaxed">{insight.suggestedReply}</p>
                </div>
              )}
