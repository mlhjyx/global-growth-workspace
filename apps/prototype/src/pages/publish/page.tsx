...
> = {
  ...
  客户成功案例: {
    ...
    content:
      '🎯 挑战：一家面向北美市场的 SaaS 企业，面临获客成本高、线索转化率低的双重困境。\n\n💡 解决方案：\n1. 部署 AI 驱动 ICP 画像系统，精准定位高价值潜客\n2. 建立多渠道自动化内容分发体系\n3. 实施预测性线索评分模型\n\n📈 核心成果：\n- 海外营收增长 127%\n- 获客成本降低 42%\n- 销售周期缩短 35%\n- 线索到商机转化率提升 3.2 倍\n\n点击阅读完整案例 →',
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              disabled={
                !title.trim() || !content.trim() || selectedConnected.length === 0 || publishing
              }
            ...
            <div className="rounded-2xl bg-white/[0.02] p-5">
              ...
              <div className="space-y-2 mb-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-start gap-2 text-xs text-foreground-600 leading-relaxed"
                  >
              ...
              {selectedConnected.map((pid) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="ml-auto text-[10px] text-foreground-700">
                      {p.followerCount.toLocaleString()} 粉丝
                    </span>
                  </div>
                );
              })}
