      ...
      >
        <div className="flex items-center gap-4">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-white text-base md:text-lg font-semibold">{selectedCampaign.name}</h1>
              <span className={`text-xs ${statusColor[selectedCampaign.status]}`}>
        ...
        <div className="flex flex-wrap items-center gap-1.5 md:gap-4 text-[11px] md:text-xs">
          <div className="flex items-center gap-1.5 text-foreground-500">
            <span className="w-3.5 h-3.5 flex items-center justify-center"><i className="ri-user-3-line text-xs"></i></span>
            <span>负责人: <span className="text-foreground-300">{selectedCampaign.owner}</span></span>
          </div>
          <div className="flex items-center gap-1.5 text-foreground-500">
            <span className="w-3.5 h-3.5 flex items-center justify-center"><i className="ri-money-cny-circle-line text-xs"></i></span>
            <span>预算: <span className="text-foreground-300">{selectedCampaign.budget}</span></span>
          </div>
          <div className="flex items-center gap-1.5 text-foreground-500">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-primary-400 text-xs font-medium">{selectedCampaign.progress}%</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row flex-1 md:overflow-hidden overflow-y-auto">
        ...
        >
          ...
          <div className="shrink-0 px-3 py-1.5 flex items-center gap-2 bg-primary-500/[0.03] border-y border-primary-500/[0.08]">
            ...
            <span className="text-foreground-600 text-[10px] uppercase tracking-wider font-medium">战役阶段</span>
          </div>
          {/* Stage navigator */}
