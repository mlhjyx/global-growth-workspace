  ...
  JA: {
    ...
    steps: [
      ...
      { id: 'lead', label: 'Lead', path: '/accounts', hint: '在四队列中确认一批合格线索' },
      {
        ...
        label: 'Campaign',
        path: '/campaigns',
        hint: '编排画布：受众/内容/序列就位',
      },
      {
        id: 'authorize',
        label: '授权',
        path: '/campaigns',
        hint: 'Dry-Run 预检后批准并签发执行授权',
      },
  ...
  JB: {
    ...
    steps: [
      { id: 'goal', label: '目标', path: '/dashboard', hint: '在目标启动器确认招募国家与产品线' },
      {
        ...
        label: '市场包',
        path: '/research',
        hint: '查看 Market/Industry Pack 与准入要点',
      },
      {
        id: 'partners',
        label: '渠道线索',
        path: '/accounts',
        hint: '基于贸易/协会数据确认候选经销商',
      },
      {
        id: 'content',
        label: '内容',
        path: '/content',
        hint: '生成基于 Approved Claim 的招募内容',
      },
