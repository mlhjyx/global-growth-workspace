...
Track B 后端去风险:            双轨启动计划见 docs/program/M1_BACKEND_FOUNDATION_PLAN.md（PR #19，待业务负责人最终批准）；
                             节奏 BE-01α→M0-05→BE-02→M0-06→BE-03→Gate1；SPK-TMP/OPA/MGW 可并行；WIP=1 个 BE 运行时 PR
```
