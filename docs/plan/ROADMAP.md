...
M0-1 数据与术语层:            ✅ MERGED（PR #1，main CI 验证通过 752e499）
M0-2 治理组件:                进行中
M0-3 补缺页面 / M0-4 旅程串线: 计划中
架构去风险线（并行 Spike）:     待启动（不等 M0 结束）
...
| PR | 内容 | 状态 |
|---|---|---|
| M0-1 数据与术语层 | mock 全换 contracts/fixtures；三级结果链/状态机/六维评分/意图枚举对齐；删 D-019 违规文案；品牌清理；导航 7→6 | ✅ [PR #1](https://github.com/mlhjyx/global-growth-workspace/pull/1) 已合并 |
| M0-2 治理组件 | Evidence Drawer、Cost/Policy Badge、ApprovalCard（差异对比）、Dry Run→授权流（模拟）、八态骨架 | **进行中** |
